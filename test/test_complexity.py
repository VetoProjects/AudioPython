...
melodies = [[note(3, 2),  note(7, 2),  note(10, 2), note(2, 3),
            ...
            [note(0, 2),  note(3, 2),  note(7, 2),  note(10, 2),
             note(0, 3),  note(7, 2),  note(3, 2),  note(7, 2)],
            [note(8, 1),  note(0, 2),  note(3, 2),  note(7, 2),
             note(8, 2),  note(7, 2),  note(8, 2),  note(7, 2)],
            [note(5, 1),  note(10, 2),  note(2, 2),  note(5, 2),
             note(10, 3),  note(2, 3),  note(5, 3),  note(2, 3)]]


bassline = [[note(3, 1), note(3, 1), note(3, 1), note(3, 1),
             note(3, 1), note(3, 1), note(3, 1), note(2, 1)],
            [note(0, 1), note(0, 1), note(0, 1), note(0, 1),
             note(0, 1), note(0, 1), note(0, 1), note(-2, 1)],
            [note(8, 0), note(8, 0), note(8, 0), note(8, 0),
...
def melody(t=0):
    ...
    while True:
        ...
        yield (sqr(t,
                   melodies[int(math.floor(counter/16) % 4)][int(counter % 8)],
                   0.11)
               + sqr(t,
                     bassline[int(math.floor(counter/16) % 4)]
                             [int(counter % 8)],
                     0.11))
